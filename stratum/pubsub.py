...
class Subscription(object):
    ...
    def get_key(self):
        ...
        hash_input = str((self.event, self.params))
        print(hash_input)
        encoded_hash_input = hash_input.encode('utf-8')
        print(encoded_hash_input)
        hashmd5 = hashlib.md5(encoded_hash_input).hexdigest()
        print(hashmd5)
        return hashmd5
